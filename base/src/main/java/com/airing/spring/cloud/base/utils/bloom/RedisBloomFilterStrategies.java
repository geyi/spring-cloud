...
enum RedisBloomFilterStrategies implements RedisBloomFilter.Strategy {
    ...
    static final class LockFreeBitArray {
        ...
        LockFreeBitArray(long bits, String filterName) {
        ...
        LockFreeBitArray(long[] data, String filterName) {
        ...
        boolean set(long bitIndex) {
            RedissonUtils redissonUtils = SpringBeanUtils.getBean(RedissonUtils.class);
            if (redissonUtils.bitSet(this.filterName, bitIndex)) {
                return false;
            }
            /*if (get(bitIndex)) {
                return false;
         ...
         * @return boolean
         * @author GEYI
         * @date 2021年04月29日 17:15
         */
        boolean get(long bitIndex) {
            RedissonUtils redissonUtils = SpringBeanUtils.getBean(RedissonUtils.class);
            return redissonUtils.bitGet(this.filterName, bitIndex);
        ...
        LockFreeBitArray copy() {
            return new LockFreeBitArray(toPlainArray(data), filterName);
        }
